...
# import sys
# sys.path.insert(0, '/content/drive/My Drive/Colab Notebooks/Advanced Deeplearning with Tensorflow2.0')
...
# Normalize the Data (Helper Function)
...
# Prepare the Data (Dataset: CIFAR10)
